...
func main() {
	...
	var engine *mindb.EngineAdapter
	var err error
...
func executeStatement(engine *mindb.EngineAdapter, parser *mindb.Parser, input string) {
...
func runBasicMode(engine *mindb.EngineAdapter, parser *mindb.Parser) {
